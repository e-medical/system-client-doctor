...
// Filter structure suitable for appointment management
const filterStructure = [
    {
        label: "Status",
        sub: ["All", "Scheduled", "Confirmed", "In Progress", "Completed", "Cancelled"],
    },
    {
        label: "Date Range",
    ...
    {
        label: "Fee Range",
        sub: ["All", "0-1000", "1001-3000", "3001-5000", "5000+"],
    },
    {
        label: "Channel Range",
        sub: ["All", "001-050", "051-100", "101-150", "151+"],
    },
];
...
interface FilterDropdownProps {
    ...
    currentFilters: AppointmentFilterState;
}
...
export default function FilterDropdown({ onFilterChange, currentFilters }: FilterDropdownProps) {
    ...
    const handleFilterSelect = (category: string, value: string) => {
        ...
        const keyMapping: Record<string, keyof AppointmentFilterState> = {
            'Status': 'status',
        ...
        const actualKey = keyMapping[category];
        if (!actualKey) return;

        const newFilters: AppointmentFilterState = {
            ...currentFilters,
            [actualKey]: value,
        };
